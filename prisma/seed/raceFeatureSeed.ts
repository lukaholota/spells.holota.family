...
export const seedRaceFeatures = async (prisma: PrismaClient) => {
  ...
  const features: SeedFeatureCreateInput[] = [
    // ============ СЕНСИ І ПЕРЦЕПЦІЯ ============
    {
      ...
      engName: "Darkvision",
      description:
        "Ви можете бачити в тьмяному світлі на відстані 60 футів так, ніби це яскраве світло, і в темряві так, ніби це тьмяне світло. Ви не можете розрізняти кольори в темряві, лише відтінки сірого.",
    ...
    },
    {
      ...
      description:
        "Ви можете бачити в тьмяному світлі на відстані 120 футів так, ніби це яскраве світло, і в темряві так, ніби це тьмяне світло. Ви не можете розрізняти кольори в темряві, лише відтінки сірого.",
    ...
    // ============ ФЕЙ/МАГІЧНА СТІЙКІСТЬ ============
    {
      ...
      description:
        "Ви маєте перевагу при ряткидках проти зачарування, і вас неможливо магічно приспати.",
      shortDescription:
        "Перевага на ряткидки проти Зачарування та імунітет до Сну",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    {
      ...
      description:
        "Ви маєте перевагу на ряткидки Інтелекту, Мудрості та Харизми проти магії.",
    ...
    },
    {
      ...
      description:
        "Коли ваші хіт-поінти зменшуються до 0, але ви не вмираєте одразу, ви можете впасти до 1 хіт-поінту замість цього. Ви не можете використовувати цю здібність знову, доки не завершите довгий відпочинок.",
...

    {
      ...
      description:
        "Ви володієте бойовою сокирою, ручною сокирою, легким молотом і бойовим молотом.",
    ...
    },
    {
      ...
      description:
        "Ви отримуєте володіння ремісничими інструментами на ваш вибір: ковальські інструменти, пивоварні приладдя або каменярські інструменти.",
    ...
    // ============ ЩАСТЯ Й ХОРОБРІСТЬ ============
    {
      ...
      engName: "Lucky",
      description:
        "Коли ви викидаєте 1 на кубику к20 для кидка атаки, перевірки характеристики або ряткидку, ви можете перекинути кубик і повинні використати новий результат.",
    ...
    // ============ ТРАНС І СОН ============
    {
      ...
      engName: "Trance",
      description:
        "Ельфи не потребують сну. Замість цього вони глибоко медитують, перебуваючи в напівсвідомому стані, протягом 4 годин на день. Під час медитації ви можете бачити сни по-своєму; такі сни насправді є розумовими вправами, які стали рефлективними через роки практики. Після такого відпочинку ви отримуєте ті самі переваги, що й людина після 8 годин сну.",
    ...
    },
    {
      ...
      description:
        "Ви можете використати свою дію, щоб видихнути руйнівну енергію. Коли ви використовуєте свою дихальну зброю, кожна істота в зоні видиху (30 футів (лінія)) має зробити ряткидок Спритності. СК = 8 + ваш модифікатор Статури + ваш бонус Майстерності. Істота отримує 2к6 шкоди Вогнем при провалі і половину цієї шкоди при успіху. Шкода збільшується до 3к6 на 6 рівні, 4к6 на 11 рівні і 5к6 на 16 рівні. Після використання дихальної зброї ви не можете використовувати її знову, доки не завершите короткий або довгий відпочинок.",
...

    {
      ...
      description:
        "Ви маєте опір до типу шкоди, пов'язаного з вашим драконячим родоводом.",
    ...
    // ============ ПРИРОДНИЙ ОБЛАДУНОК ============
    {
      ...
      description:
        "Ваша шкура має грубу, лускоподібну текстуру. Коли ви не носите обладунки, ваш Клас Броні дорівнює 13 + ваш модифікатор Спритності. Ви можете використовувати свою природну броню для визначення вашого КБ, якщо обладунок, який ви носите, залишить вас з нижчим КБ. Переваги щита застосовуються як звичайно.",
    ...
    },
    {
      ...
      engName: "Scaled Body",
      description:
        "Ваша шкура вкрита дрібною лускою. Коли ви не носите обладунки, ваш КБ дорівнює 13 + ваш модифікатор Спритності. Ви можете використовувати щит і все одно отримувати цю перевагу.",
      shortDescription: "КБ = 13 + Спритність",
      displayType: [FeatureDisplayType.PASSIVE],
      modifiesAC: {
        naturalArmor: {
    ...
    // ============ РОЗМІРИ І ШВИДКІСТЬ ============
    {
      ...
      engName: "Nimble",
      description:
        "Ви малого розміру. Ваша швидкість не зменшується від носіння важкого обладунку.",
    ...
    },
    {
      ...
      description:
        "Ваша швидкість не зменшується від носіння важкого обладунку.",
    ...
    },
    {
      ...
      engName: "Nimbleness",
      description:
        "Ви можете рухатися крізь простір будь-якої істоти, розмір якої більший за ваш.",
    ...
    // ============ ВРОДЖЕНІ ЗДІБНОСТІ ============
    {
      ...
      description:
        "Ваш максимум хіт-поінтів збільшується на 1, і він збільшується на 1 кожного разу, коли ви отримуєте рівень.",
    ...
    },
    {
      ...
      description:
        "Ви маєте експертизу на перевірки Історії, що стосуються походження кам'яних споруд",
      shortDescription:
        "експертиза на історію в питаннях походження робіт із каменю",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    {
    ...
    },
    {
      ...
      description:
        "Ви володієте довгим мечем, коротким мечем, коротким луком і довгим луком.",
    ...
    },
    {
      ...
      description:
        "Ви володієте навичками Виживання та Поводження з тваринами.",
    ...
    // ============ РАСОВІ БОНУСИ 2024 ============
    {
      ...
      engName: "Ingenious",
      description:
        "Якщо ви провалюєте перевірку здібності використовуючи інструмент, ви можете додати бонус +к4. Ви можете використовувати цю здібність кількість разів, що дорівнює вашому бонусу володіння, і відновлюєте всі витрачені використання після завершення довгого відпочинку.",
    ...
    },
    {
      ...
      description:
        "Коли ви завдаєте критичного удару ближньобійною зброєю, ви можете ще раз кинути один із кубиків шкоди цієї зброї та додати результат до додаткової шкоди критичного удару.",
...

    {
      ...
      engName: "Flight",
      description:
        "Завдяки вашим крилам, ви маєте швидкість польоту, що дорівнює вашій швидкості ходьби. Ви не можете використовувати цю швидкість польоту, якщо носите середній або важкий обладунок.",
      shortDescription:
        "Швидкість польоту = швидкості ходьби, не робе з середнім чи важким обладунком",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    {
      name: "Пазурі",
      engName: "Talons",
      description:
        "Ви маєте пазурі, які можете використовувати для атак без зброї. Якщо ви вражаєте ними, атака завдає 1к6 + ваш модифікатор Сили рублячої шкоди замість дробильної шкоди, нормальної для атаки без зброї.",
    ...
    // ============ AASIMAR ============
    {
      ...
      description:
        "Дією ви можете торкнутися істоти й відновити їй кількість здоров'я, що дорівнює вашому Бонусу Майстерності. Після використання цієї здібності ви не можете використовувати її знову, доки не завершите довгий відпочинок.",
    ...
    // ============ BUGBEAR ============
    {
      ...
      description:
        "Якщо ви вражаєте істоту атакою в перший раунд бою, ця атака завдає додаткові 2к6 шкоди цілі. Ви можете використовувати цю здібність лише один раз за бій.",
    ...
    },
    {
      ...
      engName: "Long-Limbed",
      description:
        "Коли ви здійснюєте рукопашну атаку під час свого ходу, ваша дальність для неї збільшується на 5 футів.",
    ...
    },
    {
      ...
      engName: "Sneaky",
      description:
        "Ви володієте навичкою Непомітність. Крім того, без протискування, ви можете рухатися і зупинятися в просторі, достатньому для Малої істоти.",
      shortDescription:
        "Володіння Непомітністю + рух через простір як у Малих істот",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    ...
    // ============ CENTAUR ============
    {
      ...
      engName: "Charge",
      description:
        "Якщо ви рухаєтесь принаймні на 30 футів прямо до цілі, а потім вражаєте її рукопашною атакою зброєю в той самий хід, ви можете негайно здійснити один додатковий удар копитами Бонусною дією.",
    ...
    },
    {
      ...
      engName: "Hooves",
      description:
        "Ви маєте копита, які можете використовувати для атак без зброї. Якщо ви вражаєте ними, ви завдаєте дробильну шкоду 1к6 + ваш модифікатор Сили.",
    ...
    },
    {
      ...
      description:
        "Ви вважаєтесь на один розмір більшими, коли розраховується ваша вантажопідйомність або вага, яку ви можете штовхати чи тягнути.\n" +
        "\n" +
    ...
    // ============ DEEP GNOME ============
    {
      ...
      description:
        "Ви маєте перевагу на перевірки Спритності (Непомітність), щоб сховатися в кам'яному середовищі.",
...

    {
      ...
      shortDescription:
        "Маскування [Disguise Self], Уникнення виявлення [Nondetection]",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      givesSpells: {
    ...
    },
    {
      ...
      description:
        "Ви маєте перевагу на ряткидки Інтелекту, Мудрості та Харизми проти заклинань.",
      shortDescription:
        "Перевага на ряткидки Інтелекту, Мудрості та Харизми проти заклинань",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    {
      ...
      description:
        "Коли ви робите перевірку Непомітності, ви можете зробити перевірку з перевагою. Ви можете використовувати цю здібність кількість разів, що дорівнює вашому Бонусу Майстерності, і відновлюєте всі витрачені використання після завершення довгого відпочинку.",
      shortDescription:
        "Перевага на Непомітність кіл. разів = Бонусу Майстерності на довгий відпочинок",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      usesCountDependsOnProficiencyBonus: true, // Додаємо ✅
    },
    ...
    // ============ DUERGAR ============
    {
      ...
      description:
        "Ви маєте перевагу на ряткидки проти ілюзій та проти зачарування або паралічу.",
    ...
    },
    {
      ...
      shortDescription:
        "Збільшення/Зменшення [Enlarge/Reduce], Невидимість [Invisibility]",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      givesSpells: {
    ...
    },
    {
      ...
      description:
        "Ви маєте перевагу на ряткидки, які ви робите, щоб уникнути або завершити стан зачарування або приголомшення на собі.",
    ...
    // ============ FIRBOLG ============
    {
      ...
      engName: "Hidden Step",
      description:
        "Бонусною дією ви можете магічно стати невидимим до початку вашого наступного ходу або до моменту, коли ви атакуєте, завдаєте шкоди або змушуєте когось зробити ряткидок. Після використання цієї здібності ви не можете використовувати її знову, доки не завершите короткий або довгий відпочинок.",
    ...
    },
    {
      ...
      description:
        "Ви вважаєтесь на один розмір більшим при визначенні вашої вантажопідйомності та ваги, яку ви можете штовхати, тягнути або піднімати.",
    ...
    },
    {
      ...
      description:
        "Ви маєте здатність спілкуватися в обмежений спосіб зі Звірами, Рослинами та рослинністю. Вони можуть розуміти значення ваших слів, хоча ви не маєте спеціальної здатності розуміти їх у відповідь. Ви маєте перевагу на всі перевірки Харизми, які ви робите, щоб вплинути на них.",
      shortDescription:
        "Комунікація зі звірами і рослинами + перевага на Харизму проти них",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    ...
    },
    {
      ...
      description:
        "Ви можете затримувати дихання нескінченно довго, поки ви не недієздатні.",
    ...
    // ============ GENASI EARTH ============
    {
      ...
      description:
        "Ви знаєте замовляння Захист від зброї [Blade Ward]. Ви можете використовувати його основною дією, але також - бонусною кількість разів, що дорівнюють вашому Бонусу Майстерності, і ви відновлюєте кількість таких використань після довгого відпочинку. Коли ви досягаєте 5-го рівня, ви можете один раз використати заклинання Переміщення без сліду [Pass without Trace]. Після використання Переміщення без сліду [Pass without Trace] ви не можете використовувати це заклинання знову, доки не завершите довгий відпочинок. Ви також можете використовувати ці заклинання, використовуючи будь-які слоти заклинань відповідного рівня, які у вас є. Інтелект, Мудрість або Харизма є вашою характеристикою для цих заклинань, коли ви використовуєте їх цією здібністю (ви обираєте при виборі цієї раси).",
      shortDescription:
        "Захист від зброї [Blade Ward], Переміщення без сліду [Pass without Trace]",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      usesCountDependsOnProficiencyBonus: true, // Додаємо ✅
      givesSpells: {
    ...
    },
    {
      ...
      engName: "Earth Walk",
      description:
        "Ви можете рухатися по складній місцевості, не витрачаючи додаткового руху, якщо ви використовуєте свою швидкість ходьби по землі або підлозі.",
    ...
    // ============ GITHZERAI ============
    {
      ...
      description:
        "Ваші вроджені псіонічні здібності дають вам перевагу на ряткидки проти станів Зачарування та Переляку та ваші думки не можуть бути прочитані за допомогою телепатії, якщо ви не дозволите це.",
    ...
    // ============ GOBLIN ============
    {
      ...
      description:
        "Коли ви завдаєте шкоди істоті атакою або заклинанням, і розмір цієї істоти більший за ваш, ви можете завдати додаткову шкоду цілі, що дорівнює вашому Бонусу Майстерності. Після використання цієї здібності ви не можете використовувати її знову, доки не завершите короткий або довгий відпочинок, а також не можна використовувати більше ніж раз на хід",
      shortDescription:
        "Додаткова шкода Більшим істотам ра з на хід = Бонусу Майстерності",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.SHORT_REST,
      usesCount: 1,
    },
    {
      ...
      description:
        "Ви можете виконати дію Відступ або Сховатися Бонусною дією в кожен зі своїх ходів.",
    ...
    // ============ GOLIATH ============
    {
      ...
      description:
        "Реакцією, коли ви отримуєте шкоду, ви можете зменшити цю шкоду на 1к12 + ваш модифікатор Статури. Кількість використань на довгий відпочинок = Бонус Майстерності.",
    ...
    },
    {
      ...
      description:
        "Ви володієте навичкою Атлетика, і ви вважаєтесь на один розмір більшим при визначенні вашої вантажопідйомності та ваги, яку ви можете штовхати, тягнути або піднімати.",
      shortDescription:
        "Володіння Атлетикою + на один розмір більший для вантажопідйомності",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    {
      ...
      description:
        "Ви маєте опір до шкоди Холодом. Ви також природно акліматизуєтесь до високих місцевостей, навіть якщо ви ніколи не були на них. Це включає висоти понад 20,000 футів.",
    ...
    // ============ HARENGON ============
    {
      ...
      description:
        "Ви можете додати свій Бонус Майстерності до своїх кидків ініціативи.",
    ...
    },
    {
      ...
      description:
        "Коли ви провалюєте ряткидок Спритності, ви можете використати свою реакцію, щоб додати 1к4 до результату, потенційно перетворюючи невдачу на успіх. Ви не можете використовувати цю реакцію, якщо ви Повалені або ваша швидкість дорівнює 0.",
    ...
    },
    {
      ...
      engName: "Mimicry",
      description:
        "Ви можете точно імітувати звуки, які ви чули, включаючи голоси. Істота, яка чує звуки, які ви створюєте, може визначити, що це імітації, лише після успішної перевірки Мудрості (Аналіз поведінки) проти СК 8 + ваш бонус Майстерності + ваш модифікатор Харизми.",
      shortDescription:
        "Імітація звуків і голосів проти СК 8 + Майстерність + ХАР",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    {
      ...
      description:
        "Коли ви копіюєте письмові роботи або ремісничі вироби, створені вами чи кимось іншим, ви маєте перевагу на будь-які перевірки характеристик, які ви робите для створення точної копії.",
    ...
    },
    {
      ...
      engName: "Bite",
      description:
        "Ви маєте іклясту пащу, яку можете використовувати для безозбройних ударів. Коли ви влучаєте нею, удар завдає 1к6 + ваш модифікатор Сили рублячої шкоди замість дробильної шкоди, нормальної для безозбройного удару.",
    ...
    // ============ MINOTAUR ============
    {
      ...
      engName: "Horns",
      description:
        "Ви маєте роги, які можете використовувати для атак без зброї. Якщо ви вражаєте ними, ви завдаєте колючу шкоду 1к6 + ваш модифікатор Сили.",
    ...
    },
    {
      ...
      engName: "Goring Rush",
      description:
        "Відразу після виконання дії Ривок і руху принаймні на 20 футів прямо до цілі, ви можете вдарити її Рогами (здібність) Бонусною дією.",
      shortDescription:
        "Удар Рогами після Ривку і руху 20ф прямо Бонусною дією",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    {
      name: "Таранний удар",
      ...
      description:
        "Коли ви використовуєте дію Атака під час свого ходу, щоб зробити рукопашну атаку, ви можете спробувати штовхнути ціль вашими рогами. Ціль не повинна бути більш ніж на один розмір більшою за вас. Якщо ви вражаєте ціль, вона повинна зробити ряткидок Сили проти СК = 8 + ваш Бонус Майстерності + ваш модифікатор Сили. При провалі ви штовхаєте ціль на 10 футів від себе.",
    ...
    },
    {
      ...
      description:
        "Ви завжди знаєте, де знаходиться північ, і ви маєте перевагу на будь-яку перевірку Мудрості (Виживання), яку ви робите для навігації або відстеження.",
      shortDescription:
        "Завжди знаєте північ + перевага на навігацію/відстеження",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    ...
    },
    {
      ...
      description:
        "Коли ви робите стрибок у довжину або висоту, ви можете кинути к8 і додати число до кількості футів, які ви покриваєте, навіть під час стрибка з місця. Ця додаткова відстань вимагає переміщення як зазвичай.",
    ...
    },
    {
      ...
      engName: "Reveler",
      description:
        "Ви маєте володіння навичками Виступ та Переконання, а також одним музичним інструментом на ваш вибір.",
      shortDescription:
        "Володіння Виступом та Переконанням + володіння інструментом",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    {
      name: "Таран",
      engName: "Ram",
      description:
        "Ви можете використовувати свою голову та роги для безозбройних ударів. Коли ви влучаєте ними, удар завдає 1к6 + ваш модифікатор Сили дробильної шкоди",
    ...
    },
    {
      ...
      description:
        "Ви маєте швидкість плавання 30 футів, можете дихати під водою, і маєте опір до Холодної шкоди",
    ...
    },
    {
      ...
      description:
        "Водні тварини мають надзвичайну спорідненість з вашим народом. Ви можете передавати прості ідеї будь-якому Звіру, що має швидкість плавання. Він може розуміти ваші слова, хоча ви не маєте спеціальної здібності розуміти його у відповідь.",
    ...
    // ============ SHADAR-KAI ============
    {
      ...
      description:
        "Бонусною дією ви можете магічно телепортуватися на відстань до 30 футів у вільний простір, який ви бачите. Починаючи з 3 рівня, після телепортації ви маєте опір до всіх видів шкоди до початку вашого наступного ходу, а ваш зовнішній вигляд стає примарним та напівпрозорим. Ви можете використовувати цю здібність кількість разів, що дорівнює вашому Бонусу Майстерності, і відновлюєте всі витрачені використання після завершення довгого відпочинку.",
    ...
    },
    {
      ...
      description:
        "Спрямовуючи звіра всередині себе, ви маєте володіння однією з наступних навичок на ваш вибір: Акробатика, Атлетика, Залякування або Виживання.",
    ...
    // ============ TABAXI ============
    {
      ...
      engName: "Cat's Claws",
      description:
        "Ви маєте кігті, які можете використовувати для атак без зброї. Якщо ви вражаєте ними, ви завдаєте рублячу шкоду 1к6 + ваш модифікатор Сили замість дробильної шкоди, нормальної для атаки без зброї.",
    ...
    },
    {
      ...
      description:
        "Коли ви рухаєтесь у свій хід у бою, ви можете подвоїти своє переміщення до кінця ходу. Після використання цієї здібності ви не можете використовувати її знову, доки ви не рухатиметесь 0 футів в один зі своїх ходів.",
    ...
    },
    {
      ...
      description:
        "Завдяки вашому містичному зв'язку з природою, ви отримуєте володіння однією з наступних навичок на ваш вибір: Поводження з тваринами, Медицина, Природа, Уважність, Непомітність або Виживання.",
    ...
    },
    {
      ...
      engName: "Shell Armor",
      description:
        "Ваш панцир забезпечує вам базовий КБ 17 (ваш модифікатор Спритності не впливає на це число). Ви не можете носити легкий, середній або важкий обладунок, але якщо ви використовуєте щит, ви можете застосувати бонус щита як зазвичай.",
    ...
    },
    {
      ...
      engName: "Claws",
      description:
        "Ви маєте пазурі, які можете використовувати для безозбройних ударів. Коли ви влучаєте ними, удар завдає 1к6 + ваш модифікатор Сили рублячої шкоди замість дробильної шкоди, нормальної для безозбройного удару.",
      shortDescription: "Природна зброя 1к6 + СИЛ рубляча шкода",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    ...
    // ============ TRITON ============
    {
      ...
      shortDescription:
        "Туманна хмара [Fog Cloud], Порив вітру [Gust of Wind], Ходіння по воді [Water Walk]",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      givesSpells: {
        connect: [
    ...
    },
    {
      ...
      description:
        "Ви можете передавати прості ідеї будь-якому Звіру, Елементалю або Монстру, що має швидкість плавання. Він може розуміти ваші слова, хоча ви не маєте спеціальної здібності розуміти його у відповідь.",
      shortDescription:
        "Комунікація з водними істотами (Звір/Елементаль/Монстр)",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    {
      ...
      description:
        "Адаптовані до крижаних океанських глибин, ви маєте стійкість до пошкоджень від холоду.",
    ...
    // ============ YUAN-TI ============
    {
      ...
      description:
        "Ви маєте перевагу на ряткидки, які ви робите, щоб уникнути або завершити стан отруєння на собі. Ви також маєте опір до отруйної шкоди.",
    ...
    },
    {
      ...
      description:
        "Ви знаєте замовляння Отруйні бризки [Poison Spray]. Ви можете використовувати заклинання Дружба з тваринами [Animal Friendship] необмежену кількість разів за допомогою цієї здібності, але ви можете націлювати ним лише змій. Починаючи з 3-го рівня, ви також можете використовувати заклинання Навіювання [Suggestion] за допомогою цієї здібності. Після використання ви не можете використовувати його знову, доки не завершите довгий відпочинок. Ви також можете використовувати його, використовуючи будь-які слоти заклинань 2-го рівня або вище, які у вас є. Інтелект, Мудрість або Харизма є вашою характеристикою для цих заклинань, коли ви використовуєте їх цією здібністю (ви обираєте при виборі цієї раси).",
      shortDescription:
        "Отруйні бризки [Poison Spray], Дружба з тваринами [Animal Friendship] (змії), Навіювання [Suggestion]",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      usesCount: 1,
      givesSpells: {
    ...
    // ASTRAL ELF
    {
      ...
      engName: "Astral Fire",
      description:
        "Ви знаєте один з наступних замовлянь на вибір: Мерехтливі вогники [Dancing Lights], Світло [Light] або Священне полум'я [Sacred Flame]. Характеристика закляття - Інтелект, Мудрість або Харизма (на ваш вибір при виборі раси).",
      shortDescription:
        "1 замовляння: Мерехтливі вогники [Dancing Lights]/Світло [Light]/Священне полум'я [Sacred Flame]",
      displayType: [FeatureDisplayType.PASSIVE],
    ...
    },
    {
      ...
      description:
        "Бонусною дією ви можете магічно телепортуватися на відстань до 30 футів у вільний простір, який бачите. Можете використовувати цю здатність кількість разів, рівну вашому бонусу майстерності, і відновлюєте всі витрачені використання після довгого відпочинку.",
    ...
    },
    {
      ...
      description:
        "Вам не потрібно спати, і магія не може вас приспати. Ви можете закінчити довгий відпочинок за 4 години трансоподібної медитації. Після завершення трансу ви отримуєте володіння однією навичкою на вибір та одною зброєю або інструментом на вибір з Книги Гравця. Ви зберігаєте ці володіння до наступного довгого відпочинку.",
    ...
    // AUTOGNOME
    {
      ...
      description:
        "Ви укладені в тонкий метал або інший міцний матеріал. Поки ви не носите обладунки, ваш базовий Клас Броні дорівнює 13 + ваш модифікатор Спритності.",
    ...
    },
    {
      ...
      description:
        "Ви маєте опір до отруйної шкоди та імунітет до хвороб, маєте перевагу на ряткидки проти Паралічу та Отруєння. Вам не потрібно їсти, пити або дихати.",
      shortDescription:
        "Опір до отрути, імунітет до хвороб, перевага на ряткидки проти Отруєння та Паралічу, не треба їсти, пити та дихати",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    {
      ...
      description:
        "Коли ви робите довгий відпочинок, ви проводите щонайменше 6 годин у неактивному, нерухомому стані замість сну. У цьому стані ви виглядаєте інертним, але залишаєтесь у свідомості.",
    ...
    },
    {
      ...
      description:
        "Ви отримуєте володіння двома інструментами на ваш вибір з Книги Гравця.",
    ...
    },
    {
      ...
      description:
        "Ви володієте всією вогнепальною зброєю. Коли робите кидок атаки вогнепальною зброєю, ви можете перекинути к20 натуральні 1 або 2 один раз.",
    ...
    },
    {
      ...
      engName: "Hippo Build",
      description:
        "Ви маєте перевагу на перевірки характеристик, що базуються на Силі, та ряткидки Сили. Крім того, ви вважаєтесь на один розмір більшим при визначенні вашої вантажопідйомності та ваги, яку ви можете штовхати, тягнути або піднімати.",
      shortDescription:
        "Перевага на перевірки Сили та ряткидки + подвійна вантажопідйомність",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    ...
    // HADOZEE
    {
      ...
      description:
        "Бонусною дією ви можете використовувати ноги для маніпулювання об'єктом, відкриття або закриття дверей чи контейнерів, підняття або встановлення крихітного об'єкта.",
    ...
    },
    {
      ...
      engName: "Glide",
      description:
        "Коли ви падаєте з висоти щонайменше 10 футів над землею, ви можете використати свою реакцію, щоб розправити свої шкірні мембрани та планерувати горизонтально на кількість футів, що дорівнює вашій швидкості ходьби, і ви отримуєте 0 шкоди від падіння. Ви визначаєте напрямок планерування.",
      shortDescription:
        "Планерування на відстань швидкості ходьби + 0 шкоди від падіння",
      displayType: [FeatureDisplayType.REACTION],
    },
    {
    ...
    },
    {
      ...
      engName: "Amorphous",
      description:
        "Ви можете протиснутися через простір завширшки лише 2.5 см, за умови, що ви нічого не носите і не несете. Ви також маєте перевагу на перевірки характеристик, які ви робите, щоб ініціювати або втекти із захоплення.",
      shortDescription:
        "Протискання через 2.5 см + перевага на перевірки захоплення",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    {
      ...
      description:
        "Ви маєте опір до шкоди кислотою та отрутою, і ви маєте перевагу на ряткидки проти отруєння.",
      shortDescription:
        "Опір до кислоти та отрути + перевага на ряткидки проти отруєння",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    ...
    // THRI-KREEN
    {
      ...
      description:
        "Поки не носите обладунки, ваш панцир дає базовий Клас Броні 13 + модифікатор Спритності. Дією можете змінити колір панциру, отримуючи перевагу на перевірки Спритності (Непомітність) для переховування у відповідному середовищі.",
    ...
    },
    {
      ...
      description:
        "Маєте дві трохи менші вторинні руки під основною парою. Вторинні руки можуть маніпулювати об'єктом, відкривати/закривати двері, піднімати крихітні об'єкти або тримати зброю з властивістю легка.",
    ...
    },
    {
      ...
      engName: "Sleepless",
      description:
        "Вам не потрібен сон, і ви можете залишатись у свідомості під час довгого відпочинку, хоча все ще повинні утримуватись від напруженої діяльності, щоб отримати бонуси довгого відпочинку",
    ...
    // ============ KENDER (DRAGONLANCE) ============
    {
      ...
      shortDescription:
        "Перевага проти Переляканості + 1 автоуспіх на довгий відпочинок",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      usesCount: 1,
    },
    {
      ...
      description:
        "Завдяки містичному походженню вашого народу, ви отримуєте володіння однією з наступних навичок на ваш вибір: Аналіз поведінки, Розслідування, Спритність рук, Непомітність або Виживання.",
    ...
    },
    {
      ...
      description:
        "Будь-яка істота, яка захоплює вас або іншим чином вступає в прямий контакт з вашою шкірою, повинна здійснити ряткидок Статури зі СК 12 або стати отруєною на 1 хвилину. Отруєна істота, яка більше не контактує з вами безпосередньо, може повторити ряткидок наприкінці кожного зі своїх ходів, завершуючи ефект на собі при успіху. \n \n Ви також можете застосувати цю отруту до будь-якої колячої зброї як частину атаки цією зброєю, хоча коли ви влучаєте, отрута реагує інакше. Ціль повинна успішно виконати ряткидок Статури зі СК 12, або отримати 2к4 шкоди отрутою.\n",
      shortDescription:
        "Контакт зі шкірою = СК 12 СТА ряткидок або Отруєння 1 хв",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    {
      ...
      description:
        "Ваша довжина стрибка з місця становить 25 футів, а висота стрибка з місця — 15 футів, з розбігом чи без.",
    ...
    },
    {
      ...
      description:
        "Якщо ви не зануритеся у воду принаймні на 1 годину протягом дня, ви отримуєте один рівень виснаження наприкінці цього дня. Ви можете відновити рівні виснаження, отримані таким чином, лише зануренням у воду принаймні на 1 годину.",
    ...
    // Має бути: ac: {base: 12, bonus: Ability.DEX}
    {
      ...
      description:
        "Ви маєте міцну, лускату шкіру. Коли ви не носите обладунки, ваш Клас Броні дорівнює 12 + ваш модифікатор Спритності. Ви можете використовувати свою природну броню для визначення вашого КБ, якщо обладунок, який ви носите, залишить вас з нижчим КБ. Переваги щита застосовуються як звичайно.",
    ...
    },
    {
      ...
      description:
        "Ви маєте перевагу на ряткидки проти того, щоб бути Зачарованим, Переляканим, Паралізованим, Отруєним, Приголомшеним або Приспаним.",
    ...
    },
    {
      ...
      description:
        "Ви можете дихати повітрям і водою, але вам потрібно занурюватися принаймні раз на кожні 4 години, щоб уникнути задухи.",
      shortDescription:
        "Дихання повітрям і водою, але вимога занурення кожні 4 год",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    ...
    // Має бути: ac: {base: 12, bonus: Ability.CON}
    {
      ...
      description:
        "Ви маєте товсту, шкірясту шкіру. Коли ви не носите обладунки, ваш Клас Броні дорівнює 12 + ваш модифікатор Статури. Ви можете використовувати свою природну броню для визначення вашого КБ, якщо обладунок, який ви носите, залишить вас з нижчим КБ. Переваги щита застосовуються як звичайно.",
    ...
    },
    {
      ...
      description:
        "Ви маєте перевагу на ряткидки проти того, щоб бути Зачарованим або Переляканим.",
    ...
    },
    {
      ...
      engName: "Keen Smell",
      description:
        "Завдяки вашому чутливому хоботу, ви маєте перевагу на перевірки Мудрості (Уважність), Мудрості (Виживання) та Інтелекту (Розслідування), які включають нюх.",
    ...
    // ============ VEDALKEN (GGTR) ============
    {
      ...
      description:
        "Ви маєте перевагу на всі ряткидки Інтелекту, Мудрості та Харизми.",
    ...
    },
    {
      ...
      description:
        "Ви володієте однією з наступних навичок на ваш вибір: Магія, Історія, Розслідування, Медицина, Виступ або Спритність рук. Ви також володієте одним інструментом на ваш вибір. Кожного разу, коли ви робите перевірку здібності з обраною навичкою або інструментом, киньте к4 і додайте число, що випало, до загального результату перевірки.",
    ...
    },
    {
      ...
      description:
        "Завдяки вашій біоінженерії, ви маєте здатність дихати під водою протягом до 1 години. Після використання цієї здібності ви не можете використовувати її знову, доки не завершите довгий відпочинок.",
    ...
    // ============ VERDAN (ACQUISITIONS INCORPORATED) ============
    {
      ...
      description:
        "Чорна кров, що є ознакою зв'язку вашого народу з Тим-Що-Витримує, посилює ваше природне зцілення. Коли ви викидаєте 1 або 2 на будь-якому Кубику хітів, який ви витрачаєте наприкінці короткого відпочинку, ви можете перекинути кубик і повинні використати новий результат.",
    ...
    },
    {
      ...
      engName: "Persuasive",
      description:
        "Відсутність історії вашого народу робить вас гідним довіри та скромним. Ви маєте володіння навичкою Переконання.",
    ...
    },
    {
      ...
      description:
        "Зв'язок вашого розуму зі світом навколо вас зміцнює вашу волю. Ви маєте перевагу на всі ряткидки Мудрості та Харизми.",
    ...
    // ============ WARFORGED (EBERRON) ============
    {
      ...
      description:
        "Ви були створені, щоб мати чудову витривалість. Ви маєте перевагу на ряткидки проти того, щоб бути Отруєним, і ви маєте опір до отруйної шкоди. Ви маєте імунітет до хвороб. Вам не потрібно їсти, пити або дихати. Вам не потрібно спати, і магія не може приспати вас.",
      shortDescription:
        "Перевага проти Отруєння + опір до poison + імунітет до хвороб + без їжі/питва/дихання/сну",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    {
    ...
    },
    {
      ...
      description:
        "Ви отримуєте володіння однією навичкою на ваш вибір та володіння одним інструментом на ваш вибір.",
    ...
    // ============ LEONIN (MYTHIC ODYSSEYS OF THEROS) ============
    {
      ...
      description:
        "Ваші пазурі є природною зброєю, яку ви можете використовувати для безозбройних ударів. Якщо ви влучаєте ними, ви завдаєте рублячу шкоду 1к4 + ваш модифікатор Сили замість дробильної шкоди, нормальної для безозбройного удару.",
    ...
    },
    {
      ...
      description:
        "Ви володієте однією з наступних навичок на ваш вибір: Атлетика, Залякування, Уважність або Виживання.",
    ...
    },
    {
      ...
      description:
        "Ви маєте швидкість лазіння, що дорівнює вашій швидкості ходьби. Окрім того, на 3-му рівні ви можете рухатися вгору, вниз і вздовж вертикальних поверхонь та догори дриґом вздовж стель, залишаючи руки вільними.",
      shortDescription:
        "Швидкість лазіння = швидкості ходьби + лазіння по стінах",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    {
      ...
      shortDescription:
        "Укус з модифікатором СТА (1к4) + самозцілення або бонус",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
    },
    ...
    },
    {
      ...
      shortDescription:
        "Маскування [Disguise Self] та Прокляття [Hex] раз на відпочинок",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      givesSpells: {
    ...
    // Baalzebul
    {
      ...
      shortDescription:
        "Дивотворство, Промінь хвороби (3), Корона шаленства (5)",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      givesSpells: {
        connect: [
    ...
    // Hellfire
    {
      ...
      description:
        'Ві знаєте замовляння <a href="/spell/1357">Дивотворство [Thaumaturgy]</a>. Коли ви досягаєте 3-го рівня, ви можете один раз використати заклинання <a href="/spell/1321">Палючі долоні [Burning Hands]</a>. Коли ви досягаєте 5-го рівня, ви також можете один раз використати заклинання <a href="/spell/1249">Темрява [Darkness]</a>. Після використання кожного з цих заклять ви не можете використовувати це заклинання знову, доки не завершите довгий відпочинок. Харизма є вашою заклинальною характеристикою для цих заклинань.',
    ...
    // Winged
    {
      ...
      description:
        "Ви маєте швидкість польоту 30 футів. Щоб використовувати цю швидкість, ви не можете носити середні або важкі обладунки.",
    ...
    },
    {
      ...
      shortDescription:
        "Лінія 5x30 футів, 2к6 шкоди блискавкою (ряткидок Спритності)",
      displayType: [FeatureDisplayType.ACTION],
      limitedUsesPer: RestType.SHORT_REST,
      usesCount: 1,
    },
    {
      ...
      shortDescription:
        "Лінія 5x30 футів, 2к6 шкоди вогнем (ряткидок Спритності)",
      displayType: [FeatureDisplayType.ACTION],
      limitedUsesPer: RestType.SHORT_REST,
      usesCount: 1,
    },
    {
      ...
      shortDescription:
        "Конус 15 футів, 2к6 шкоди вогнем (ряткидок Спритності)",
      displayType: [FeatureDisplayType.ACTION],
      limitedUsesPer: RestType.SHORT_REST,
      usesCount: 1,
    },
    {
      ...
      description:
        "Ви можете використати свою дію, щоб видихнути руйнівну енергію. Коли ви використовуєте свою зброю дихання, усі істоти в зоні повинні зробити ряткидок Статури. СК цього ряткидка дорівнює 8 + ваш модифікатор Статури + ваш бонус володіння.\n\nІстота отримує 2к6 отруйної шкоди при провалі та половину цієї шкоди при успіху. Шкода збільшується до 3к6 на 6-му рівні, 4к6 на 11-му і 5к6 на 16-му рівні.\n\n**Форма:** конус 15 футів\n**Ряткидок:** Статура\n**Тип шкоди:** отрута\n\nПісля використання вашої зброї дихання ви не можете використати її знову, доки не завершите короткий або тривалий відпочинок.",
    ...
    },
    {
      ...
      shortDescription:
        "Конус 15 футів, 2к6 променевої шкоди (ряткидок Статури)",
      displayType: [FeatureDisplayType.ACTION],
      limitedUsesPer: RestType.SHORT_REST,
      usesCount: 1,
    },
    {
      ...
      shortDescription:
        "Конус 15 футів, 2к6 психічної шкоди (ряткидок Статури)",
      displayType: [FeatureDisplayType.ACTION],
      limitedUsesPer: RestType.SHORT_REST,
      usesCount: 1,
    },
    ...
    },
    {
      ...
      shortDescription:
        "Конус 15 футів, 2к6 некротичної шкоди (ряткидок Статури)",
      displayType: [FeatureDisplayType.ACTION],
      limitedUsesPer: RestType.SHORT_REST,
      usesCount: 1,
    },
    ...
    // Mark of Storm
    {
      ...
      description:
        "Коли ви робите перевірку Спритності (Акробатика [Acrobatics]) або будь-яку перевірку, пов'язану з навігацією або транспортними засобами, ви можете кинути к4 і додати результат до перевірки.",
    ...
    },
    {
      ...
      description:
        "З вашої спини виростають два світлові ефірні крила, даруючи вам швидкість польоту 30 футів. На додаток, один раз у кожен свій хід, ви можете завдати додаткову променеву шкоду 1к10 одній цілі при влученні атакою. Трансформація триває 1 хвилину або до кінця вашого ходу, якщо ви втратили свідомість.",
...

    {
      ...
      description:
        "Як бонусну дію ви можете прийняти більш звірячу форму. Ця трансформація триває 1 хвилину, до вашої смерті або до того, як ви відмінюєте її бонусною дією. Коли ви перевертаєтесь, ви отримуєте тимчасові хіт-пойнти, рівні 1к6 + ваш модифікатор Статури (мінімум 1). Під час перевертання ви отримуєте бонус +1 до Класу Броні.",
    ...
    },
    {
      ...
      description:
        'Ви можете використовувати заклинання <a href="/spell/1306">Сигнал тривоги [Alarm]</a> та <a href="/spell/1326">Магічна броня [Mage Armor]</a>. Починаючи з 3-го рівня, ви можете використовувати заклинання <a href="/spell/1300">Аркан ний замок [Arcane Lock]</a>. Після використання будь-якого з цих заклинань ви не можете використовувати його знову, доки не завершите довгий відпочинок. Інтелект є вашою заклинальною характеристикою для цих заклинань.',
    ...
    },
    {
      ...
      description:
        'Ви знаєте замовляння <a href="/spell/1050">Штукарство [Prestidigitation]</a>. Ви також можете використовувати заклинання <a href="/spell/1323">Очищення їжі та напоїв [Purify Food and Drink]</a> та <a href="/spell/1340">Доброягода [Goodberry]</a> по одному разу за допомогою цієї риси. Після використання будь-якого з них ви не можете використовувати його знову, доки не завершите довгий відпочинок. Харизма є вашою заклинальною характеристикою для цих заклинань.',
      shortDescription:
        "Prestidigitation, Purify Food and Drink та Goodberry 1/день",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      usesCount: 1,
    },
    ...
    },
    {
      ...
      description:
        'Ви знаєте замовляння <a href="/spell/1344">Повідомлення [Message]</a>. Ви також можете використовувати заклинання <a href="/spell/1315">Розуміння мов [Comprehend Languages]</a> по одному разу за допомогою цієї риси. Починаючи з 3-го рівня, ви також можете використовувати заклинання <a href="/spell/1282">Магічні вуста [Magic Mouth]</a> по одному разу за допомогою цієї риси. Після того, як ви використали Comprehend Languages або Magic Mouth за допомогою цієї риси, ви не можете використовувати це заклинання знову, доки не завершите довгий відпочинок. Інтелект є вашою заклинальною характеристикою для цих заклинань.',
    ...
    },
    {
      ...
      description:
        'Ви можете використовувати заклинання <a href="/spell/1339">Дружба з тваринами [Animal Friendship]</a> та <a href="/spell/1317">Розмова з тваринами [Speak with Animals]</a>. Починаючи з 3-го рівня, ви також можете використовувати заклинання <a href="/spell/1459">Звірячі узи [Beast Bond]</a>. Після того, як ви використали будь-яке з цих заклинань за допомогою цієї риси, ви не можете використовувати його знову, доки не завершите довгий відпочинок. Мудрість є вашою заклинальною характеристикою для цих заклинань.',
      shortDescription:
        "Animal Friendship, Speak with Animals та Beast Bond 1/день",
      displayType: [FeatureDisplayType.PASSIVE],
      limitedUsesPer: RestType.LONG_REST,
      usesCount: 1,
    },
    {
      ...
      description:
        "Коли ви накладаєте заклинання Дружба з тваринами [Animal Friendship] або Розмова з тваринами [Speak with Animals], ви можете націлюватися на Істот (Monstrosity), якщо їхній показник Інтелекту 3 або нижче.",
    ...
    },
    {
      ...
      description:
        'Ви знаєте замовляння <a href="/spell/1353">Лагодження [Mending]</a>.',
    ...
    },
    {
      ...
      description:
        'Ви можете використовувати заклинання <a href="/spell/1302">Щит [Shield]</a>. Починаючи з 3-го рівня, ви також можете використовувати заклинання <a href="/spell/1274">Охоронний зв’язок [Warding Bond]</a>. Після того, як ви використали будь-яке з цих заклинань за допомогою цієї риси, ви не можете використовувати його знову, доки не завершите довгий відпочинок. Мудрість є вашою заклинальною характеристикою для цих заклинань.',
    ...
    },
    {
      ...
      description:
        "Коли істота, яку ви бачите в межах 5 футів від вас, отримує влучання атакою, ви можете використати свою реакцію, щоб магічно помінятися місцями з цією істотою. Ви отримуєте влучання цією атакою замість неї. Ви не можете використовувати цю здатність знову, доки не завершите довгий відпочинок.",
    ...
    },
    {
      ...
      description:
        'Ви знаєте замовляння <a href="/spell/1351">Мала ілюзія [Minor Illusion]</a>. Починаючи з 3-го рівня, ви можете використовувати заклинання <a href="/spell/1276">Невидимість [Invisibility]</a> один раз за допомогою цією рисою і не можете робити це знову, доки не завершите довгий відпочинок. Харизма є вашою заклинальною характеристикою для цих заклинань.',
