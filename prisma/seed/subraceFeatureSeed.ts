...
export const seedSubraceFeatures = async (prisma: PrismaClient) => {
    ...
    const features: SeedFeatureCreateInput[] = [
        ...
        },
        {
            ...
            description: 'Ви маєте перешкоду на кидки атаки та на перевірки  Уважність (Мудрість), які покладаються на зір, коли ви, ціль вашої атаки або те, що ви намагаєтеся сприйняти, знаходиться під прямим сонячним світлом.',
