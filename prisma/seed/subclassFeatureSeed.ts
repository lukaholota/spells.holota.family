...
export const seedSubclassFeatures = async (prisma: PrismaClient) => {
  ...
  const features: SeedFeatureCreateInput[] = [
    ...
    },
    {
      ...
      description:
        "На 2 рівні ви можете використати Свій Виклик божественності, щоб освіжити союзників заспокійливими сутінками.\n\nДією ви демонструєте священний символ, і від вас розходиться сфера сутінків. Сфера має центр у вас, радіус 30 футів і заповнена тьмяним світлом. Вона рухається разом із вами та триває 1 хвилину або доки ви не станете недієздатним чи не помрете.\n\nЩоразу, коли істота (включно з вами) завершує свій хід у сфері, ви можете надати їй один із таких ефектів:\n\nВона отримує тимчасові хіти, рівні 1к6 + ваш рівень клірика.\nВи завершуєте один ефект, що робить її причарованою або наляканою.",
      displayType: [FeatureDisplayType.ACTION],
      usesPoolKey: "CHANNEL_DIVINITY",
      usePrice: 1,
    },
    ...
    },
    {
      ...
      description: "На 8 рівні ви здобуваєте здатність насичувати удари зброєю божественною енергією. Один раз у кожному своєму ході, коли ви влучаєте по істоті атакою зброєю, ви можете завдати цій атаці додатково 1к8 променистої шкоди. Коли ви досягаєте 14 рівня, ця додаткова шкода зростає до 2к8.",
      displayType: [FeatureDisplayType.PASSIVE],
    },
    {
